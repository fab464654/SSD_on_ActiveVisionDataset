...
class Config:
    backbone = 'vgg16'  # [vgg16, resnet-fpn, mobilenet, resnet50_fpn]
    ...
    num_class = 33 + 1  # foreground + 1 background
    data_root_dir = "./google_drive/MyDrive/ColabNotebooks/Project/trainDataset"
    model_save_dir = "./"
